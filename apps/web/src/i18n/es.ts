...
const es: Messages = {
  ...
  dashboard: {
    ...
    planSession: "Planear una sesión",
    settings: "Ajustes",
    ...
    viewRide: "Ver salida →",
    upcomingSessionEyebrow: "Próximamente",
  ...
  settings: {
    ...
    devices: { title: "Dispositivos de entrenamiento", description: "Para qué dispositivo(s) planeas sesiones estructuradas." },
  ...
  training: {
    brand: "Soft Floyd / Entrenamiento",
    eyebrow: "Planear una sesión",
    title: "¿Qué deberías rodar la próxima vez?",
    intro: "Cuéntame qué tienes en mente y lo combinaré con tu entrenamiento reciente en una sola sesión.",
    loadError: (error) => `No se pudieron cargar las sesiones de entrenamiento: ${error}`,
    planError: (error) => `No se pudo planear esta sesión: ${error}`,
    devices: {
      title: "¿Con qué dispositivo entrenas?",
      body: "Esto define cómo puedes llevar una sesión a tu bici o rodillo. Puedes cambiarlo después en Ajustes.",
      garmin: "Garmin Edge / reloj",
      wahoo: "Wahoo",
      zwift: "Zwift",
      other: "Otro",
      continue: "Continuar",
    ...
    form: {
      ...
      settingLabel: "Dónde",
      indoor: "Bajo techo / rodillo",
      outdoor: "Al aire libre",
      disciplineLabel: "Bici",
      bikeLabel: "Qué bici",
      ideaLabel: "Tu idea (opcional)",
      ideaPlaceholder: "p. ej., repeticiones de subida en Patios",
      feelLabel: "¿Cómo te sientes?",
      fresh: "Fresco",
      normal: "Normal",
      tired: "Cansado",
      submit: "Armar mi sesión",
      building: "Armando tu sesión…",
    },
    offSchedule: "Este no es uno de tus días habituales de salida; está bien, lo dejamos flexible.",
    rationaleLabel: "Por qué esta sesión",
    adjustmentsLabel: "Qué cambió de tu idea",
    sourcesAria: "Fuentes de libros",
    emphasisLabel: {
      recovery: "Recuperación", endurance: "Resistencia", tempo: "Tempo",
      threshold: "Umbral", vo2: "VO2 máx.", climbing: "Subidas",
    },
    stepKind: {
      warmup: "Calentamiento", interval: "Intervalo", recovery: "Recuperación", cooldown: "Enfriamiento",
    },
    repeatLabel: (count) => `× ${count}`,
    untilLapButton: "Hasta que presiones vuelta",
    estMinutes: (n) => `~${n} min`,
    actions: {
      sendToGarmin: "Enviar a Garmin",
      sending: "Enviando…",
      sentAt: (when) => `Enviado a Garmin ${when}`,
      garminError: (error) => `No se pudo enviar a Garmin: ${error}`,
      download: "Descargar",
    ...
    formats: {
      fit: ".fit — cualquier unidad GPS",
      zwo: ".zwo — Zwift / SYSTM",
      erg: ".erg — software de rodillo en modo ERG",
    },
    upcomingHeading: "Próximas",
    historyHeading: "Sesiones pasadas",
    noSessions: "Aún no hay sesiones planeadas.",
